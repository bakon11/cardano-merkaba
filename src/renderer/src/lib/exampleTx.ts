...
import { koiosAPI, kupoAPI, genKeys, a2hex, splitAsset, fromHexString, fromBuffer, toBuffer, hex2a, constructKoiosProtocolParams, ogmiosHealth } from "./utils.ts";
...
const buildTx = async () => {
  ...
  */
  ...
  console.log("accountAddress Key Hash from @harmoniclabs/bip32_ed25519 ", toBuffer( blake2b_224(accountAddressKeyPub.toPubKeyBytes())));
